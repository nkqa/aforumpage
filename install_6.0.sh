...
get_node_url(){
	...
	downloads_Url=http://download.bt.sy/ltd
	echo "Download node: $download_Url";
	echo '---------------------------------------------';
}
Remove_Package(){
...
Install_Bt(){
    ...
    wget -T 5 -O /www/server/panel/pyenv/lib/python3.7/site-packages/requests/api.py $downloads_Url/script/api.py
